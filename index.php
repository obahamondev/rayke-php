                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-3">
                                <div class="header-right-btn f-right d-none d-lg-block">
                                    <a href="#" class="btn header-btn">Contáctanos</a>
                                </div>
                            </div>
                            <!-- Mobile Menu -->
                            <div class="col-12">
            ...
            <div class="slider-active">
                ...
                <div class="single-slider">
                    <div class="slider-cap-wrapper">
                        ...
                        <div class="hero__caption">
                            <h1 data-animation="fadeInLeft" data-delay=".4s"> <br>Aprovecha la Tecnología</h1>
                            <p data-animation="fadeInLeft" data-delay=".6s">En estos momentos en que el mundo está cambiando y la tecnología viene creciendo exponencialmente, se han producido múltiples tecnologías que nosotros aplicamos en soluciones de negocio para proteger y acelerar tu evolución.</p>
                            <!-- Hero Btn -->
                            <a href="#" class="hero-btn" data-animation="fadeInLeft" data-delay=".9s">
                                  Ver Proyecto
                                  <!-- Arrow SVG icon -->
                ...
                <div class="row align-items-end">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="wantToWork-caption">
                            <p>Haz realidad la idea más descabellada.</p>
                    ...
                    <div class=" col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                ...
                                <p>Construimos desde el sitio web más sencillo en tiempo récord hasta complejas aplicaciones de gran escala</p>
                            </div>
                        </div>
                    </div>
                    <div class=" col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class=" col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                ...
                                <p>Internet de las cosas, Ciberseguridad, Big Data son algunas de las tecnologías disruptivas que te llevarán al siguiente nivel</p>
                            </div>
                        </div>
                    </div>
                </div>
